...
47 comedy movies had an MPAA rating and lasted over 120 minutes with a rating of 8.
...
The movies included in this data are Harry Potter and the Chamber of Secrets, Harry Potter and the Prisoner of Azkaban, and Harry Potter and the Sorcerers Stone. Harry Potter and the Prisoner of Azkaban had the highest rating and Sorcerers Stone had the most votes.
...
The movie Wild Wild West had a budget of $170000000 making it have the highest budget out of movies that were animation or comedy.

5. Is your favorite movie in the dataset? What other questions could you ask or answer using `filter()`, `select()`, and `arrange()`?


One of my favorite movies is unfortunately not on this list. One of my favorite movies is called Jujutsu Kaisen 0 it's a fantastic film. 

You could use the "or" function and arrange by rating to ask certain questions. Using these codes we could compare movies like Harry Potter to Star Wars by filtering or selecting their ratings and votes.
